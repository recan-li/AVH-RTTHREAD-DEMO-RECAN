 ...
 * @param buffer is the inout result pointer, it will be rt_reallocated
 ...
 * called to rt_free sample data when an image is destroyed.
 */
 ...
 * passes the image data buffer to rt_free()
 */
extern void zbar_image_rt_free_data(zbar_image_t *image);
...
/** control the processor in rt_free running video mode.
