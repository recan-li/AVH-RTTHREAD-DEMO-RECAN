...
void SysTick_Handlerx(void) __NO_RETURN;
...
extern const VECTOR_TABLE_Type __VECTOR_TABLE[];
  ...
  SysTick_Handlerx,                   /*  -1: SysTick Handler */
...
{
    __set_PSP((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Limit));

    __set_MSPLIM((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Base));
    __set_PSPLIM((uint32_t)(&Image$$ARM_LIB_STACK$$ZI$$Base));
